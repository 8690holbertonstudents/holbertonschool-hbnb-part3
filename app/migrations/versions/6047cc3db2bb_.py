...
Revision ID: 6047cc3db2bb
Revises: 
Create Date: 2024-06-30 23:43:25.264323
...
def upgrade():
    ...
    sa.Column('adress', sa.String(length=256), nullable=False),
    ...
    sa.Column('additional_data', sa.String(length=128), nullable=True),
